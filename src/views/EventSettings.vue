<template lang="html">
  ...
  <script>
  import EventMainCard from '../components/Dashboard/EventMainCard.vue'
  import EventMainCardActiveSwitch from '../components/Dashboard/EventMainCardActiveSwitch.vue'
  import ShareSiteModal from '../components/Dashboard/ShareSiteModal.vue'
  ...
  import MiniMenu from '../components/Dashboard/MiniMenu.vue'

  import EditsTopBar from '../components/EditEvent/EditsTopBar'
  import SettingsSideMenu from '../components/EditEvent/SettingsSideMenu'
  
  import EventSettingsComponent from '../components/EditEvent/EventSettings'
