<template lang="html">
  <b-container fluid  class="mt-3" style="height: 100%;">
    <upload-main-view-header ref="photosMainViewHeader" v-if="!freeupload" />
    ...
    <photos-uploading :content = "content" :checkpoint = "checkpoint" :freeupload = "freeupload" />
    <!-- <photos-upload-screen v-show="this.$store.getters['Events/getEventContent'].length === 0 && getCurrentFilter !== 'Uploading'"/> -->
    <div v-if="!freeupload" class="dz-default dz-message" @click="clickUpload" v-show="this.$store.getters['Events/getEventContent'].length === 0 && getCurrentFilter !== 'Uploading'">
...
<script>
import UploadMainViewHeader from "./UploadMainViewHeader"
import PhotosSelectAllBar from "../ContentManager/PhotosSelectAllBar"
import PhotosManager from "../ContentManager/PhotosManager"
import PhotosFooter from "../ContentManager/PhotosFooter"
import PhotosUploading from "../ContentManager/PhotosUploading"
import PhotosCheckpointModal from "../ContentManager/PhotosCheckpointModal"
// import PhotosUploadScreen from './PhotosUploadScreen'

export default {
  name: "upload-main-view",
  props: ['content', 'checkpoint', 'freeupload'],
  components: {
    UploadMainViewHeader,
    PhotosSelectAllBar,
    PhotosManager,
    PhotosFooter,
    PhotosUploading,
